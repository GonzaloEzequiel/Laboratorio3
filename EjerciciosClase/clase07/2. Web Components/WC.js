...
class ListarDesdeApi extends HTMLElement {
    ...
    constructor() {
        ...
        let referenciaDos = this.attachShadow({mode: 'open'});
        ...
        referenciaDos.appendChild(this.divDos);
        this.divDos.appendChild(this.subtitulo);

        referenciaDos.appendChild(this.divTres);
    }
...
class CustomCard extends HTMLElement {
    ...
    constructor() {
        ...
        // Utilizamos Clone Node para clonar 
